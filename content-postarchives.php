...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		<h2><?php esc_html_e( 'Archives by Category', 'silvercord' ); ?></h2>
		...
		<h2><?php esc_html_e( 'Archives by Month', 'silvercord' ); ?></h2>
		<ul class="content-archives-by-month">
			<?php wp_get_archives( 'type=monthly' ); ?>
		</ul>

		<?php wp_link_pages( array( 'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'silvercord' ), 'after' => '</div>' ) ); ?>
	</div><!-- /.entry-content -->
